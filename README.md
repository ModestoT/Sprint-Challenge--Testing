...
1. In Jest, what are the differences between `describe()` and `it()` globals, and what are good uses for them?
    ...
    describe() is a way to organize sections of your test by the function the test are for or overfile/component. 
    it() is used for preforming the actual test and should describe what the test is trying to achieve.

1. What is the point of `Test Driven Development`? What do you think about this approach?

    The point of doing TDD is to allow you to write code that is easier to refactor and that is testable(more well designed code potentially). The approach is weird to me at the moment, but with time and more practice I can get use to it. I don't know if I would choose to do TDD of my own volition though.

1. Mention three types of automated tests.

    Unit testing - Fast, simple to write and execute.
    Component testing - appearance and functionality of a component, good agaist regression
    snapshot testing - generated by Jest, checks current output vs prior output
